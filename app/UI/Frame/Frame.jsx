...
export default class Frame extends Component {
  render() {
    return (
        <div style={{ margin: this.props.margin,  position: this.props.position,  top: this.props.top,  bottom: this.props.bottom,  right: this.props.right,  left: this.props.left, width: this.props.width, height: this.props.height}} className={classNames(styles.frame, border(this.props.border), this.props.classNames)}>
